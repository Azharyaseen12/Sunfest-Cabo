  ...
  return (
    <footer className="bg-[#F821DB1A] text-white pt-12 pb-4">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 flex justify-center md:justify-start">
            <img
              src="/hero.png"
              alt="Inclufy AI"
              className="h-60 w-auto mb-4 cursor-pointer max-w-full"
          ...
          <div className="col-span-1 text-center md:text-left">
            ...
            <p className="text-[#707070] max-w-xs mx-auto md:mx-0">
          ...
          {/* Contact Us */}
          <div className="col-span-1 flex justify-center md:justify-end items-top mb-4">
        ...
        {/* Copyright */}
        <div className="border-t border-[#F821DB] pt-2 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[#F821DB] text-center md:text-left">
